...
class FunctionDeclaration(val type: Lexer.Token?, val name: Lexer.Token, val args: List<InputArgument>, val body: Block, start: Lexer.Context, end: Lexer.Context) : Node(start, end) {
